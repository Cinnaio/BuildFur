...
//    protected static final AxisAlignedBB AABB_CENTER_EAST = new AxisAlignedBB(1, 0, 0, 1.5, 1, 1);
//
//    protected static final AxisAlignedBB AABB_CENTER_NORTH = new AxisAlignedBB(0, 0, 0, 1, 1, -0.5);
//    protected static final AxisAlignedBB AABB_CENTER_SOUTH = new AxisAlignedBB(0, 0, 1, 1, 1, 1.5);
//
//    protected static final AxisAlignedBB AABB_CENTER_A = new AxisAlignedBB(0, 0, 0, -0.5, 1, -0.5);
//    protected static final AxisAlignedBB AABB_CENTER_B = new AxisAlignedBB(1, 0, 0, 1.5, 1, -0.5);
//    protected static final AxisAlignedBB AABB_CENTER_C = new AxisAlignedBB(0, 0, 1, -0.5, 1, 1.5);
//    protected static final AxisAlignedBB AABB_CENTER_D = new AxisAlignedBB(1, 0, 1, 1.5, 1, 1.5);
...
//        return new cn.mscraft.entities.MarbledFloorTurquoise();
//    }
